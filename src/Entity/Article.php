...
{   
     ...
     * @Assert\NotBlank(message="Get creative & insert a title")
     */
    private $title;
     ...
     * @Assert\NotBlank(message="Enter author")
     */
    private $author;
    ...
    public function updateHeartCount(): self{
    ...
    public function validate(ExecutionContextInterface $context, $payload)
    {
        if(strpos($this->getTitle(), 'the borg') !== false){
            $context->buildViolation("Don't like this word")
                    ->atPath('title')
                    ->addViolation();
        }
    }
